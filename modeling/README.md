...
where the inputs are the steering angle rate $\omega$ and the vehicle velocity $v$. States are the $\theta$ as the heading angle, $\delta$ is steering angle, and $x_c$ and $y_c$ are the movements of the gravity center of the car in the related $XY$ directions.
